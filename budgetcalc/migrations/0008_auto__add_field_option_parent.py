...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Option.parent'
        db.add_column('budgetcalc_option', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['budgetcalc.Option'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Option.parent'
        db.delete_column('budgetcalc_option', 'parent_id')
    ...
    models = {
        ...
        'budgetcalc.option': {
            ...
            'order': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['budgetcalc.Option']", 'null': 'True', 'blank': 'True'}),
