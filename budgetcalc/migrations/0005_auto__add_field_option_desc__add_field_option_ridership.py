...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Option.desc'
        db.add_column('budgetcalc_option', 'desc', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Option.ridership'
        db.add_column('budgetcalc_option', 'ridership', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Option.desc'
        db.delete_column('budgetcalc_option', 'desc')

        # Deleting field 'Option.ridership'
        db.delete_column('budgetcalc_option', 'ridership')
